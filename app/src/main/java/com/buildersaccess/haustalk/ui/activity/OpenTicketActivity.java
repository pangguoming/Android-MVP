...
import com.buildersaccess.haustalk.presenter.impl.OpenTicketstPresenterImpl;
...
public class OpenTicketActivity extends AppCompatActivity implements ShowTicketsView {
    ...
    private TicketsPresenter openTicketsPresenter;
    private int page = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        openTicketsPresenter = new OpenTicketstPresenterImpl(this);
        this.isLoad = false;
        ...
        lvResult.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (listHomevendorDat != null) {
                    ...
                    intent.setClass(OpenTicketActivity.this, PmticketviewActivity.class);
    ...
    public void refreshView() {
        ...
        this.openTicketsPresenter.ba_openticketpm(req_ba_openticketpm);
    }
