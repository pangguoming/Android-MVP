...
import com.buildersaccess.haustalk.presenter.impl.OpenSurveyPresenterImpl;
...
public class OpenSurveyActivity extends AppCompatActivity implements ShowTicketsView {
    ...
    private OpenSurveyPresenter openSurveyPresenter;
    private int page = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        openSurveyPresenter = new OpenSurveyPresenterImpl(this);
        this.isLoad = false;
        ...
        lvResult.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (listHomevendorDat != null) {
                    ...
                    intent.setClass(OpenSurveyActivity.this, PmticketviewActivity.class);
                    OpenSurveyActivity.this.startActivity(intent);
    ...
    public void refreshView() {
        ...
        this.openSurveyPresenter.ba_surveyticketpm(req_ba_openticketpm);
    }
