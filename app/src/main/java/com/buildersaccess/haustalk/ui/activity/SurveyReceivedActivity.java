...
import com.buildersaccess.haustalk.presenter.impl.SurveyReceivedPresenterImpl;
...
public class SurveyReceivedActivity extends AppCompatActivity implements ShowTicketsView {
    ...
    private SurveyReceivedPresenter surveyReceivedPresenter;
    private int page = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HaustalkApplication.getInstance().addActivity(this);
        UiTools.setBackActionBarLayout(this, "Open Tickets");
        surveyReceivedPresenter = new SurveyReceivedPresenterImpl(this);
        this.isLoad = false;
        ...
        lvResult.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (listHomevendorDat != null) {
                    ...
                    intent.setClass(SurveyReceivedActivity.this, PmticketviewActivity.class);
                    SurveyReceivedActivity.this.startActivity(intent);
    ...
    public void refreshView() {
        ...
        this.surveyReceivedPresenter.ba_recivedsurveypm(req_ba_openticketpm);
    }
