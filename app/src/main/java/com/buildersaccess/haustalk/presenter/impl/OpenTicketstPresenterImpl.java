 ...
 */
public class OpenTicketstPresenterImpl implements TicketsPresenter,OnTicketsListener,OnLoginListener {
    private Model model;
    private ShowTicketsView showTicketsView;
    private Req_ba_openticketpm req_ba_openticketpm;
    public OpenTicketstPresenterImpl(ShowTicketsView showTicketsView) {
    ...
    public void ba_openticketpm(Req_ba_openticketpm req_ba_openticketpm) {
        ...
        this.model.ba_openticketpm(req_ba_openticketpm,this);
    }
    @Override
